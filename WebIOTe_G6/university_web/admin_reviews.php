...
<div class="admin-container">
    <a href="admin.php" class="btn-back">กลับไปหน้าจัดการบุคลากร</a>
...
<script>
// 🚨 อัปเกรดฟังก์ชันกรองให้ทำงานร่วมกันทั้ง Dropdown และ ช่องค้นหา
function filterReviews() {
    ...
    rows.forEach(row => {
        ...
        // ตรรกะ: 
        // 1. เช็คว่า Dropdown ตรงไหม (ถ้าเลือก all ถือว่าผ่าน)
        let matchDropdown = (filterVal === "all" || filterVal === pid);
        
        // 2. เช็คว่าที่พิมพ์ค้นหาตรงกับชื่อไหม (ถ้าปล่อยว่าง ถือว่าผ่าน)
        let matchSearch = (name.includes(searchVal));
        
        // ถ้าตรงทั้ง 2 เงื่อนไข ค่อยโชว์
...
// ฟังก์ชัน SweetAlert2 สำหรับถามยืนยันก่อนลบคอมเมนต์
function confirmDeleteReview(reviewId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = 'admin_reviews.php?delete_review_id=' + reviewId;
        }
    });
}
</script>
