...
<head>
    ...
    <title>Faculty Member - IoTe</title>
...
<body>
    ...
    <div class="page-header">
        Faculty Member (IoT and Information Engineering)
    </div>

    <div class="page-background">
        <div class="content-card">

            <h2 class="faculty-title">คณะอาจารย์ภาควิชาวิศวกรรมไอโอทีและสารสนเทศ</h2> 
            ...
            <h2 class="faculty-title">บุคลากรสายสนับสนุนภาควิชาวิศวกรรมไอโอทีและสารสนเทศ</h2>
            <div class="faculty-group">
                <?php 
                foreach($all_staff as $member) { 
