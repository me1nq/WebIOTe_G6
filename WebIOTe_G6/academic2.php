...
// 🔴 ดึงข้อมูลจากตาราง academic2 (หลักสูตร 2 ปริญญา)
...
<body>
    ...
    <div class="page-header">
        Bachelor of Engineering (Physics + IoT)
    </div>
    ...
    <div class="page-background">
        <div class="content-card">
            ...
            <div class="info-box" style="background-color: <?= htmlspecialchars($data['bg_color'] ?? '#ffffff') ?>">
            ...
            <div class="button-group">
                <?php if (!empty($data['pdf_path'])) : ?>
                    <a href="<?= htmlspecialchars($data['pdf_path']) ?>" target="_blank" class="main-btn">
                        ข้อมูลหลักสูตรฟิสิกส์อุตสาหกรรม และวิศวกรรมระบบไอโอทีและสารสนเทศ 2 ปริญญา
                    </a>
                <?php endif; ?>
            </div>
