...
<div class="admin-container">
    <a href="faculty.php" class="btn-back">กลับไปหน้าจัดการบุคลากร</a>
...
function confirmDeleteReview(reviewId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            // 🚨 แก้ลิงก์เป็น faculty_reviews.php
            window.location.href = 'faculty_reviews.php?delete_review_id=' + reviewId;
        }
    });
}
</script>
