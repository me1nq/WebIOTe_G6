    ...
    <div class="content-card">
      <div class="info-grid">
        <div class="content-left">
          ...
          <a href="admin/index_edit.php"
            style="display:inline-block; margin-top:20px; color: #ff6600; font-weight:bold;">
            [ Edit Content ]
          </a>
          <?php endif; ?>
        ...
        <div class="stats-right">
          <div class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <div class="stat-desc">วศ.บ. ฟิสิกส์อุตสาหกรรม และ วศ.บ. วิศวกรรมระบบไอโอทีและสารสนเทศ (หลักสูตรสองปริญญา)
              </div>
            </div>
            <div class="stat-card">
              <div class="stat-header">
            ...
            <div class="stat-card">
              ...
              <div class="stat-desc">ปริญญาโท วิศวกรรมศาสตรมหาบัณฑิต (ไอโอทีและสารสนเทศ) และปริญญาเอก ปรัชญาดุษฎีบัณฑิต
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="news-column">
          ...
          <div class="news-card-item">
            ...
            <div class="news-content-box">
              <p class="news-meta"><i class="far fa-calendar-alt"></i>
                <?php echo date('j ม.ค. Y', strtotime($news['date_posted'])); ?></p>
        ...
        <div class="sidebar-column">
          <div class="sidebar-block announcement-list">
            ...
            <a href="#" class="link-view-all"
              style="color:#FF6F00; font-weight:bold; display:block; text-align:right;">ดูประกาศทั้งหมด →</a>
          </div>
