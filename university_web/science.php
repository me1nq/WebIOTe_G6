...
// ตรรกะสำคัญอยู่ตรงนี้: ใช้ WHERE program = 'science' เพื่อกรองเอาเฉพาะอาจารย์วิทย์
...
<head>
    ...
    <title>Faculty Member - Science (Double Degree)</title>
    <link rel="stylesheet" href="style.css"> 
    
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>

    <style>
        /* สไตล์สำหรับสร้าง Scrollbar ใน Pop-up (เหมือน index.php) */
        .modal-scroll-area {
            max-height: 45vh; /* ล็อกความสูงไว้ที่ 45% ของหน้าจอ */
            overflow-y: auto; /* ถ้าเนื้อหายาวกว่าให้มีแถบเลื่อนแนวตั้ง */
            padding-right: 15px; 
            margin-bottom: 15px;
        }
        ...
        /* ปรับขนาดรูปงานวิจัยไม่ให้ใหญ่เกินไป */
        .research-cover {
            max-height: 180px; 
            width: auto; 
            border-radius: 5px;
...
<body>
    ...
    <div class="container">
        <h1>Professor of Industrial Physics</h1>
        <h2>คณาจารย์หลักสูตรฟิสิกส์อุตสาหกรรม</h2> 

        <div class="faculty-group">
            <?php 
            // เช็คว่ามีข้อมูลไหม ถ้าไม่มีให้ขึ้นข้อความบอก
        ...
        <h2>บุคลากรหลักสูตรฟิสิกส์อุตสาหกรรม</h2>
        <div class="faculty-group">
            <?php 
            foreach($all_staff as $member) { 
